                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Certificates/የምስክር ወረቀት</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Certificate Lists/የምስክር ወረቀት ዝርዝር</h1>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>
                                                    <td class="datatable-ct"><a href="certificates.php?viewid=<?php echo htmlentities ($row->ID);?>"><button class="btn btn-white btn-action btn-xs" value="fff" onclick='generateBarCode();'><i class="fa fa-folder"></i> View/እይ</button></a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
