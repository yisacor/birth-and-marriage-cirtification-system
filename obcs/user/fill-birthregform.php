...
echo "<script>alert('Date of Birth and Father Name is  already exist. Please try again|በትክክል አላስገቡም');</script>";
   ...
   <?php include_once('includes/sidebar.php');?>
        <?php include_once('includes/header.php');?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Birth Registration Form/የልደት የመመዝገቢ ቅፅ</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="basic-form-area mg-b-15">
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Application Form/የመመዝገቢያ ቅፅ</h1>
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Date of Birth/የልደት ቀን</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-9 col-sm-9 col-xs-9">
                                                                    <label class="login2 pull-right pull-right-pro"><span class="basic-ds-n">Gender/ፆታ </span></label>
                                                                </div>
                                                                <div class="col-lg-9 col-md-3 col-sm-3 col-xs-3">
                                                                    <div class="bt-df-checkbox">
                                                                       <p style="text-align: left;"> <input type="radio"  name="gender" id="gender" value="Female" checked="true">Female/ሴት</p>
             
                                                                   <p style="text-align: left;"> <input type="radio" name="gender" id="gender" value="Male">Male/ወንድ </p>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Full Name/ ሙሉ ስም</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Place of Birth/  የትውልድ ቦታ</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Full Name of Father/ የአባት ሙሉ ስም</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Permanent Address/ቋሚ አድራሻ</label>
                                                                </div>
                                                                <div class="col-lg-9">
                ...
                <label class="col-sm-4 form-control-label">Photo<span></label>
                <div class="col-sm-8 mg-t-100 mg-sm-t-0">
                  <input type="file" name="husimage" value="" class="form-control" required='true'>
                                                         ...
                                                         <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Contact Number/ስልክ ቁጥር </label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                       ...
                                                       <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Email/ኢሜል </label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="submit">Add Details/አስገባ</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
