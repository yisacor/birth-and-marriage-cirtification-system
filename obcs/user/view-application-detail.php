                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>View <span class="table-project-n">Detail of</span> Application|ዝርዝር የመመዝገቢ ቅፅ  ማያ</h1>
...
<td colspan="4" style="font-size:20px;color:blue">
 ...
 <tr>
   ...
   <tr>
    <th scope>Date of Birth|የልደት ቅን</th>
  ...
  <tr>
    ...
    <th scope>Permanent Address|የአሁን አድራሻ</th>
   ...
   <tr>
    ...
    <th scope>Date of apply|የተሰጠብት ቀን</th>
    <td><?php  echo $row->Dateofapply;?></td>
  </tr>
  <tr>
    <th scope>Remark|አስተያየት</th>
    <?php if($row->Remark==""){ ?>

                     <td><?php echo "Your apllication still pending|በመሰራት ላይ"; ?></td>
<?php } else { ?>                  <td><?php  echo htmlentities($row->Remark);?>
                  </td>
                  <?php } ?>
    <th scope>Status|ሁኔታ</th>
    <?php if($row->Status==""){ ?>

                     <td><?php echo "Pending|በመሰራት ላይ"; ?></td>
