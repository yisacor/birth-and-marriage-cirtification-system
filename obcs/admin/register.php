                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1>Registration Form|የምዝገባ ቅፅ</h1>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                ...
                                                <button type="submit" class="login-button login-button-lg" name="submit">Register|ተመዝገብ</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
