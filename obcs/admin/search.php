                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Search Application|ምዝገባ ፈልግ</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Search <span class="table-project-n"></span> All Application|ሁሉም ምዝገባ</h1>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Search by Application Number<br> በምዝገባ ቁጥር ፈልግ</br></label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                     <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Application Number|የምዝገባ ቁጥር">
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="search">Search|ፈልግ</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> No record found against this search|ብዚ ቁጥር የትቀዳ የለም</td>
