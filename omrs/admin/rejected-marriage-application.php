...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Rejected Marriage Application|ያልተላለፈ የጋብቻ ምዝገባ</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Rejected Marriage Application|ያልተላለፈ የጋብቻ ምዝገባ</h6>
...
{               ?>
                ...
                <?php if($row->Status==""){ ?>
                     ...
                     <td><?php echo "Still Pending|በመሰራት ላይ ገፅ"; ?></td>
