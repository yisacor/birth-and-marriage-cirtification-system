...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Change Password|የይልፍ ቃል ቀይር</h5>
        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Change Password|የይልፍ ቃል ቀይር</h6>
               <form id="basic-form" method="post" onsubmit="return checkpass();" name="changepassword" >
               
              <div class="row">
                <label class="col-sm-4 form-control-label">Current Password|የአሁን ይልፍ  ቃል : <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="password" name="currentpassword" id="currentpassword" class="form-control" required="true">
                </div>
              </div><!-- row -->
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">New Password|አዲስ ይልፍ  ቃል: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="password" name="newpassword"  class="form-control" required="true">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Confirm Password|ደግምው ያስገቡ : <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
             ...
             <p style="text-align: center;"><button class="btn btn-info mg-r-5"  name="submit" id="submit">Change|ለውጥ</button></p>
                </form>
              </div>
            </div>
          </div>
