  ...
  ?>
                ...
                <div class="media pd-x-20 pd-y-15">
                  ...
                  <div class="media-body">
                    <p class="tx-13 mg-b-0"><strong class="tx-medium">New Application|አዲስ ምዝገባ: <?php echo $row->RegistrationNumber;?></strong><label style="color: green;padding-left: 10px"> <?php echo $row->HusbandName;?></label></p>
              ...
              <div class="media-list-footer">
                <a href="all-marriage-application.php" class="tx-12"><i class="fa fa-angle-down mg-r-5"></i> Show All Marriage Application|አዲስ ምዝገባ አሳይ</a>
              </div>
            </div><!-- media-list -->
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
...
{               ?>
          ...
          <div class="dropdown-menu wd-200">
            <ul class="list-unstyled user-profile-nav">
              <li><a href="admin-profile.php"><i class="icon ion-ios-person-outline"></i> Edit Profile|መግለጫ </a></li>
              <li><a href="change-password.php"><i class="icon ion-ios-gear-outline"></i> Settings|መቼት </a></li>
              <li><a href="logout.php"><i class="icon ion-power"></i> Sign Out|ውጣ </a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
      </div><!-- am-header-right -->
