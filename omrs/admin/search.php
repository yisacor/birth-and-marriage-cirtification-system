...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Search Marriage Application| ፈልግ የጋብቻ ምዝገባ</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Search Marriage Application|ፈልግ የጋብቻ ምዝገባ</h6>
        <form id="basic-form" method="post" enctype="multipart/form-data">
              
              <div class="row">
                <label class="col-sm-4 form-control-label">Search by Reg Number|ፈልግ በምዝገባ ቁጥር: <span class="tx-danger">*</span></label>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> No record found against this date|ብዚ ቁጥር የትቀዳ የለም </td>
