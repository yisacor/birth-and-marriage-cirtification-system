        ...
        <div class="row row-sm mg-t-20">
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              <h6 class="card-body-title">Change Password|የይለፍ ቃል ቀይር</h6>
               <form id="basic-form" method="post" onsubmit="return checkpass();" name="changepassword" >
               
              <div class="row">
                <label class="col-sm-4 form-control-label">Current Password|ያሁኑ ይለፍ ቃል: <span class="tx-danger">*</span></label>
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">New Password|አዲስ ይለፍ ቃል: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
