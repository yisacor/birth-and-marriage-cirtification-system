      ...
      <div class="am-pagetitle">
        ...
        <form id="searchBar" class="search-bar" action="index.html">
          <div class="form-control-wrapper">
            <input type="search" class="form-control bd-0" placeholder="Search|ፈልግ">
          </div>
...
{               ?>
                    <h4>Welcome to Our System|እንካን ደና መጡ|| <?php  echo $row->FirstName;?> <?php  echo $row->LastName;?></h4><?php $cnt=$cnt+1;}} ?>
